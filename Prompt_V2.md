...
- What new technologies the companies are developing
- What new products or services the companies are working on

## Step 3
What indsiders of the selected companies are buying or selling

## Step 4
Dive into specific industies
- Pharma
- Biotech
...
## Step 6
Display the outcomes of the research in a webpage and store the results into a database




# Operations:
- Fetch the most recent 13F
- Pay attention to the Period of Repeat
- Extract data and put it into the database
- Download historic 13F for selected range, pay attention to the Period of Repeat
- Compare differences between selected periods